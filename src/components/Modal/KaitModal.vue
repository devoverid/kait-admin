...
<transition name="fade">
            ...
            <div :class="{'kait-component kait-modal-wrapper absolute  w-100 h-screen top-0 left-0 right-0 bottom-0 flex justify-center items-center':true}" v-show="open"  @click="closeModal($event)" :style="{background:background}">
                <div class="kait-modal-container container mx-auto">
                    <transition name='fade-slide-down'>
                        <div :class="{'kait-modal bg-white mx-auto rounded-md': true,  'w=full': size=='lg', 'w-2/4': size=='md', 'w-1/3': size=='sm'}"  v-show="open">
